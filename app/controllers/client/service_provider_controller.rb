class Client::ServiceProviderController < ApplicationController
  def show
  ...
  def service_provider_informations_form_params
    parameters = params.require(:service_provider_informations_form).permit(:firstname,:lastname,:email,:phone_number,:is_a_plumber,:is_a_locksmith,:is_a_glazier,:status,:number_of_employees,:file_kbis,:file_professional_insurance,:file_iban,:has_a_smartphone,)
  end
