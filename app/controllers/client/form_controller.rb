class Client::FormController < ApplicationController
  ...
  def create
    #raise user_informations_form_params.inspect
    ...
    if @user_informations_form.save
      ...
      intervention = CreateInterventionService.perform(@user_informations_form.address, @user_informations_form.customer, intervention_type, session[:profession_id],@user_informations_form.is_immediate,@user_informations_form.date_intervention)
